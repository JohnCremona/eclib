...
void show_time() { cerr<<setprecision(3)<<" ("<<T.user_time()/1000.0<<" seconds)"<<flush; }
...
void show_conic_timer() { cerr<<setprecision(3)<<"Time spent so far in solving conics was "<<conic_time<<" seconds\n"; }
...
void show_time() { cerr<<setprecision(3)<<" ("<<(stoptime-starttime)<<" seconds)" << flush; }
...
void show_time() { cerr<<setprecision(3)<<" ("<<(stoptime-starttime)*1./CLK_TCK<<" seconds)"<<flush; }
