...
private:
  ...
  vec opmat_col(int i, int j, int v=0) override
  {return h1->opmat_col(i,j,v);}
  mat opmat_cols(int i, const vec_i& jlist, int v=0) override
  ...
  svec s_opmat_col(int i, int j, int v=0) override
  {return h1->s_opmat_col(i,j,v);}
  smat s_opmat_cols(int i, const vec_i& jlist, int v=0) override
